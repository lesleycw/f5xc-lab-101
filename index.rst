...
**Last updated: 2022-11-14 11:30 PM PST**
...
- Deploying F5 Distributed Cloud WAF into a cloud provider network (Azure) to protect internal Private IP resources


Lab & Tasks:
~~~~~~~~~~~~

The next page (Introduction) will cover the lab environment, access, and lab variables. The lab will be using a shared Azure account where we have deployed the following resources:

- NGINX webserver that is exposed to the Public internet ("Public Endpoint")
- F5 AppMesh node that can be used to connect to Azure vNet (network)
